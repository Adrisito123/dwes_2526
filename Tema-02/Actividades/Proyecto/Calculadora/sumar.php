<<<<<<< HEAD:tema-02/actividades/Proyecto/Calculadora/sumar.php
<?php
...
include '../../../Recursos/plantillas/index.html';
        ...
        echo "<h4 class='mb-3'>Resultado: <span class='text-success'>$resultado</span></h4>";
?>
=======
<!DOCTYPE html>
<html lang="es">
...
<div class="container py-5">
    <div class="card shadow-sm p-4">
        <h3 class="mb-3 text-primary">Resultado de la Suma</h3>
...
>>>>>>> 27233006adfc85fbf5daad1dfd88613591e7a040:Tema-02/Actividades/Proyecto/Calculadora/sumar.php
